...
void setup_scene(PCISPH& sim, eScene scene)
{
    sim.clear();

    /* setup boundaries */
    sim.boundary({0, -3.5}, {0.0, 1.0}, {-5.0, -3.5 - sim.radiusKernel}, {+5.0, -3.5});
    sim.boundary({-5.0f, 1.5}, {1.0, 0.0}, {-5.0 - sim.radiusKernel, -3.5 - sim.radiusKernel}, {-5.0, 8.0});
    sim.boundary({5.0f, 1.5}, {-1.0, 0.0}, {5.0, -3.5 - sim.radiusKernel}, {5.0 + sim.radiusKernel, 8.0});
